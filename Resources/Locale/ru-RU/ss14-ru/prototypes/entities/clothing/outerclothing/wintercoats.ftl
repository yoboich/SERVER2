...
ent-ClothingOuterWinterBar = зимняя куртка бармена
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
ent-ClothingOuterWinterCap = зимняя куртка главно-управляющего
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
...
ent-ClothingOuterWinterChem = зимная куртка химика
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
...
ent-ClothingOuterWinterHoP = зимняя куртка главы персонала
    .desc = { ent-ClothingOuterWinterCoat.desc }
ent-ClothingOuterWinterHoS = зимняя куртка директора милиции
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
...
ent-ClothingOuterWinterViro = зимняя куртка вирусолога
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
ent-ClothingOuterWinterWarden = зимняя бронекуртка инспектора
    .desc = Прочная, утилитарная зимняя куртка, предназначенная для защиты инспектора от любых угроз, связанных с бригом, и переохлаждением.
ent-ClothingOuterWinterSyndieCap = зимняя куртка Синдиката
    .desc = Зимняя куртка Синдиката, изготовлена из прочной ткани с позолоченными узорами и грубой шерсти.
ent-ClothingOuterWinterSyndieCapArmored = зимняя бронекуртка Синдиката
    .desc = Зимня бронекуртка Синдиката, изготовлена из прочной ткани с позолоченными узорами и грубой шерсти.

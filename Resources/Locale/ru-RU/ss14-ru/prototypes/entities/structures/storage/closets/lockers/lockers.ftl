...
ent-LockerQuarterMaster = шкаф управляющего хозяйством
...
ent-LockerCaptain = шкаф главно-управлябщего
...
ent-LockerHeadOfSecurity = шкаф директора милиции
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerWarden = шкаф инспектора
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerBrigmedic = шкаф милицейского медика
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerSecurity = шкаф старшего милиционера
    .desc = { ent-LockerBaseSecure.desc }

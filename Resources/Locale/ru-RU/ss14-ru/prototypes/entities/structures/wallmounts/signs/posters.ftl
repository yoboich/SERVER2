...
ent-PosterContrabandRebelsUnite = Мятежники объединяйтесь
    .desc = Плакат, призывающий читателя восстать против USSP.
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвященного 50-летию USSP.
...
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв эскадрона смерти USSP сегодня!
...
ent-PosterLegitNoERP = Скажи "нет" ERP!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография запрещены на станциях "USSP".
...
ent-PosterLegitThereIsNoGasGiant = Газового гиганта не существует
    .desc = USSP распространила плакаты, подобные этому, по всем станциям, напоминая, что слухи о газовом гиганте недостоверны.
...
ent-PosterLegitVacation = Корпоративные привилегии USSP: Отпуск
...
ent-PosterLegitRenault = Постер с Алисой
    .desc = Йап.
ent-PosterLegitNTTGC = Тактическая карточная игра USSP
    .desc = Реклама новой ТКИ от USSP: ПОКУПАЙТЕ БОЛЬШЕ КАРТОЧЕК.

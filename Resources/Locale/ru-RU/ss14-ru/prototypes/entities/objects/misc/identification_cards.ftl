...
ent-ResearchAssistantIDCard = ID карта научного ассистента
    .desc = { ent-PassengerIDCard.desc }
ent-SecurityCadetIDCard = ID карта милиционера
    .desc = { ent-PassengerIDCard.desc }
ent-ServiceWorkerIDCard = ID карта обслуживающего персонала
    .desc = { ent-PassengerIDCard.desc }
ent-CaptainIDCard = ID карта гланвного управляющего
    .desc = { ent-IDCardStandard.desc }
ent-SecurityIDCard = ID карта милиции
    .desc = { ent-IDCardStandard.desc }
ent-WardenIDCard = ID карта инспектора
    .desc = { ent-IDCardStandard.desc }
...
ent-SalvageIDCard = ID карта утилизатора
    .desc = { ent-IDCardStandard.desc }
ent-QuartermasterIDCard = ID заведующего хозяйством
    .desc = { ent-IDCardStandard.desc }
...
ent-RDIDCard = ID карта научного руководителя
    .desc = { ent-IDCardStandard.desc }
ent-HoSIDCard = ID карта директора милиции
    .desc = { ent-IDCardStandard.desc }
ent-BrigmedicIDCard = ID карта бригмедика
    .desc = { ent-IDCardStandard.desc }
ent-CentcomIDCard = ID карта старшего милиционера
    .desc = { ent-IDCardStandard.desc }
ent-ERTLeaderIDCard = ID карта ОСН

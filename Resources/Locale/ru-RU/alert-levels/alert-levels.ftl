...
alert-level-blue-announcement = На станции присутствует неизвестная угроза. Милиции разрешено проводить выборочные обыски. Членам экипажа рекомендуется выполнять указания, отдаваемые действующей властью.
alert-level-blue-instructions = Членам экипажа рекомендуется проявлять бдительность и сообщать милиции o любой подозрительной активности.
alert-level-red = Красный
alert-level-red-announcement = На станции присутствует известная угроза. Милиция имеет право применять летальную силу по необходимости. Члены экипажа должны укрыться в безопасном месте и следовать указаниям, отдаваемым действующей властью.
...
alert-level-gamma-announcement = Генеральный штаб объявил на станции уровень угрозы "Гамма". Милиция должна постоянно иметь при себе оружие, гражданский персонал обязан немедленно обратиться к главам отделов для получения указаний к эвакуации. Милиции разрешено применение летальной силы в случае неповиновения.
...
alert-level-epsilon-announcement = Генеральный штаб расторгает все контракты со станцией, персоналу приказывается оставаться на станции до прибытия сил специальных операций.
